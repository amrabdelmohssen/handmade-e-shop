    ...
    const valid = (e)=>{
        switch (e.target.name) {
            ...
            case "email":
                ...
                setvalidEmail("email is required and must be valid") :setvalidEmail("")
            
                break;
           case "phone":
                !phoneRegex.test(e.target.value) ?
                setValidPhone("phone not valid") :setValidPhone("")
                break;
...
return (
    ...
    <div class="mb-3">
            ...
            <input type="text" class="form-control" id="phone" name="phone" onChange={e=>{valid(e); setPhone (e.target.value)}} placeholder="phone" defaultValue={street}/>
     ...
     <div class="mb-3">
            ...
            <input type="text" class="form-control" id="country" name="country" onChange={e=>{setCountry (e.target.value)}} placeholder="country" defaultValue={country}/>
    </div>
    <div class="mb-3">
            <label for="exampleFormControlInput1" class="form-label">City</label>
            <input type="text" class="form-control" id="city" name="city" onChange={e=>{setCity (e.target.value)}} placeholder="city" defaultValue={city}/>
    </div>
    <div class="mb-3">
